  ...
  <ul class="collection-list">
    <li>
      <router-link
        ...
        class-active="active"
        class="list-button"
        ><img src="@/assets/svgs/TinyTap.svg" class="list-logo" />TinyTap</router-link
      >
    </li>
    <li>
      <router-link
    ...
    <li>
      <router-link
        :to="{ name: 'marketplace', params: { name: 'grasp' } }"
        class-active="active"
        class="list-button"
        ><img src="@/assets/images/Grasp-Icon.png" class="list-logo" />Grasp EDU
        Courses</router-link
      >
    </li>
  </ul>
