      ...
      <div class="nft-details">
        <div class="nft-view-row">
          <div class="nft-column-start">
            ...
            <div
              v-else-if="token.token && token.token.tokenId"
              class="nft-title"
            >
              #{{ token.token.tokenId }}
            </div>
          ...
          <div class="nft-column-end">
            <div
              v-if="token.market && token.market.floorAsk.price"
              class="nft-floor"
            >
              <div class="nft-floor-amount">
                ...
                >
                  ...
                  <img
                    v-else-if="
                      token.market.floorAsk.price.currency.symbol === 'WETH'
                    "
