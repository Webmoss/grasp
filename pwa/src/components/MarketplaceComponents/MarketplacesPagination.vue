<template>
  <div v-if="pagination" class="marketplace-pagination">
    <button class="marketplace-pagination-button" @click="setFirstPage(pagination.page)">
      <img src="../../assets/svgs/FirstPage.svg" />
    </button>
    <button class="marketplace-pagination-button" @click="setPreviuosPage(pagination.page)">
      <img src="../../assets/svgs/Left.svg" />
    </button>
    <div class="marketplace-pagination-page">
      {{ pagination.page }}
    </div>
    <button class="marketplace-pagination-button" @click="setNextPage(pagination.page)">
      <img src="../../assets/svgs/Right.svg" />
    </button>
    <button class="marketplace-pagination-button" @click="setLlastPage(pagination.page)">
