<template>
  <div v-if="pagination" class="lessons-pagination">
    <button class="lessons-pagination-button" @click="setFirstPage(pagination.page)">
      <img src="../../assets/svgs/FirstPage.svg" />
    </button>
    <button class="lessons-pagination-button" @click="setPreviuosPage(pagination.page)">
      <img src="../../assets/svgs/Left.svg" />
    </button>
    <div class="lessons-pagination-page">
      {{ pagination.page }}
    </div>
    <button class="lessons-pagination-button" @click="setNextPage(pagination.page)">
      <img src="../../assets/svgs/Right.svg" />
    </button>
    <button class="lessons-pagination-button" @click="setLlastPage(pagination.page)">
