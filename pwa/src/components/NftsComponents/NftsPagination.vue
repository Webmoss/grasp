<template>
  <div v-if="pagination" class="nfts-pagination">
    <button class="nfts-pagination-button" @click="setFirstPage(pagination.page)">
      <img src="../../assets/svgs/FirstPage.svg" />
    </button>
    <button class="nfts-pagination-button" @click="setPreviuosPage(pagination.page)">
      <img src="../../assets/svgs/Left.svg" />
    </button>
    <div class="nfts-pagination-page">
      {{ pagination.page }}
    </div>
    <button class="nfts-pagination-button" @click="setNextPage(pagination.page)">
      <img src="../../assets/svgs/Right.svg" />
    </button>
    <button class="nfts-pagination-button" @click="setLlastPage(pagination.page)">
